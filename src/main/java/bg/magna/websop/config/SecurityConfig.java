        ...
        return httpSecurity
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                .requestMatchers("/admin-panel", "/machines/add", "/machines/delete/", "/machines/edit/{id}", "/brands/add", "/admin-panel/initializeMockDB", "/orders/all", "/orders/dispatch/{id}", "/orders/deliver/{id}", "/parts/add", "/parts/edit/{partCode}", "/parts/delete/{partCode}", "/machines/enquiries/all", "/machines/enquiries/delete/{id}").hasRole("ADMIN")
