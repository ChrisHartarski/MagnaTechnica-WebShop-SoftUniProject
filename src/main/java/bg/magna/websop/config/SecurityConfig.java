        ...
        return httpSecurity
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                .requestMatchers("/", "/machines", "machines/{id}", "/spare-parts","/parts/{partCode}", "/company/", "/contact", "/users/login", "/users/login-error", "/users/register", "/companies/add", "/companies/").permitAll()
